...
<div class="fixed ltr:md:right-[-29px] ltr:right-0 rtl:left-0 rtl:md:left-[-29px] top-1/2 z-[888]">
    <button
            class="translate-y-1/2 bg-slate-800 text-slate-50 dark:bg-slate-700 dark:text-slate-300 cursor-pointer transform rotate-90 flex items-center text-sm font-medium px-2 py-2 shadow-deep ltr:rounded-b rtl:rounded-t"
            role="button"
            data-twe-offcanvas-toggle href="#offcanvas" aria-controls="offcanvas" data-twe-ripple-init>
...
<div class="invisible fixed bottom-0 ltr:right-0 rtl:left-0 top-0 z-[1045] flex w-96 max-w-full ltr:translate-x-full rtl:-translate-x-full flex-col border-none bg-white bg-clip-padding text-neutral-700 shadow-sm outline-none transition duration-300 ease-in-out data-[twe-offcanvas-show]:transform-none dark:bg-body-dark dark:text-white"
     tabindex="-1" id="offcanvas" aria-labelledby="offcanvas" data-twe-offcanvas-init>
    <div
